...
| `ollama.auxiliary_model` | string | `"gemma4:e4b"` | Generative model used to write per-node summaries. Optional — summaries are skipped if this model is unavailable. |
